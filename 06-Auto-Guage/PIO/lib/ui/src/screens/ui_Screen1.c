...
lv_obj_set_x( ui_img_devider, -20 );
lv_obj_set_y( ui_img_devider, -5);
...
lv_obj_set_x( ui_speed_num2, -40 );
lv_obj_set_y( ui_speed_num2, 12 );
...
lv_obj_set_x( ui_speed_num3, 5 );
lv_obj_set_y( ui_speed_num3, -8 );
...
lv_obj_set_x( ui_speed_num4, 50 );
lv_obj_set_y( ui_speed_num4, -28 );
lv_obj_set_align( ui_speed_num4, LV_ALIGN_CENTER );
lv_label_set_text(ui_speed_num4,"8");
lv_obj_set_style_text_color(ui_speed_num4, lv_color_hex(0xFFAA00), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_x( ui_speed_num5, 110 );
lv_obj_set_y( ui_speed_num5, -45 );
lv_obj_set_align( ui_speed_num5, LV_ALIGN_CENTER );
lv_label_set_text(ui_speed_num5,"10");
lv_obj_set_style_text_color(ui_speed_num5, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_x( ui_lbl_speed, -95 );
lv_obj_set_y( ui_lbl_speed, -14 );
...
lv_obj_set_width( ui_lbl_speed1, 160);
lv_obj_set_height( ui_lbl_speed1, 49);
lv_obj_set_x( ui_lbl_speed1, 20 );
lv_obj_set_y( ui_lbl_speed1, 70 );
lv_obj_set_align( ui_lbl_speed1, LV_ALIGN_CENTER );
lv_label_set_text(ui_lbl_speed1,"RPM  Batt");
...
lv_obj_set_style_text_font(ui_lbl_speed1, &ui_font_Hollow38, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_lbl_trip_value, 392 );
...
lv_obj_set_y( ui_lbl_trip, 172 );// in the ground
...
lv_obj_set_y( ui_lbl_battery_value, 40 );
...
lv_obj_set_y( ui_roller_mode, 167 );// in the ground
...
lv_obj_set_y( ui_slider_range, 250 );//in th nowhere
...
lv_obj_set_y( ui_bar_battery, 40);
...
lv_obj_set_y( ui_img_battery, 120 );
...
lv_obj_set_width(ui_lbl_range1, 204);
lv_obj_set_height(ui_lbl_range1, 49);
lv_obj_set_x(ui_lbl_range1, -10);
lv_obj_set_y(ui_lbl_range1, -46);
lv_obj_set_align(ui_lbl_range1, LV_ALIGN_CENTER);
lv_label_set_text(ui_lbl_range1, "RWB _ JANINE");
lv_obj_set_style_text_color(ui_lbl_range1, lv_color_hex(0xFFD700), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_lbl_range1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_lbl_range1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_lbl_range1, &ui_font_Hollow38, LV_PART_MAIN | LV_STATE_DEFAULT);


ui_lbl_range = lv_label_create(ui_Screen1);
lv_obj_set_width( ui_lbl_range, 99);
lv_obj_set_height( ui_lbl_range, 32);
lv_obj_set_x( ui_lbl_range, 100 );
lv_obj_set_y( ui_lbl_range, 60 );
